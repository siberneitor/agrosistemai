...
<div class="modal fade" id="modalDetalleTicket" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="formProv"  method="get" accept-charset="utf-8" class="form-horizontal">
                <div class="modal-body" id ="divDetalleTicket">
