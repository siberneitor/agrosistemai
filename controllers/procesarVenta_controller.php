...
////$printer->text("\n\n");
////$printer->text("cant"."  "."articulo"."    "."precio"."   "."total");
////$printer->text("\n\n");
//
//
...
////    $printer->text($unidXprod .'   '.$nombreProd.'   '.$precioBD.'   '.$totalXprod);
////    $printer->text("\n");
//
...
////    $printer->text("\n");
////    $printer->text("Efectivo:                 ".$cantPagada);
////    $printer->text("\n");
...
//        fwrite($file,"". PHP_EOL);
//        fwrite($file," Monto Inicial " .($numRows?'Nuevo':''). " Credito: "."        ".number_format($TOTAL,2). PHP_EOL);
////    fwrite($file,"                  Interes: "."        ".$interesVenta." %". PHP_EOL);
////    fwrite($file,"                  Interes: "."        ".'2.2% mensual'. PHP_EOL);
////    fwrite($file,"                  Total: "."        ".$cantidadTotal. PHP_EOL);
//    fwrite($file,"Pago Inicial: ".number_format($pagoInicial,2). PHP_EOL);
////    fwrite($file,"".$pagoInicial. PHP_EOL);
////    fwrite($file,"Por pagar: ".$cantidadTotal-$pagoInicial. PHP_EOL);
...
//        $differenceFormat = '%a';
////        die($contador->format($differenceFormat));
//
...
//
//    fwrite($file,"Pago al 01/07/2022: ". number_format($cantidadF1,2). PHP_EOL);
//    fwrite($file,"Pago al 01/08/2022: ".number_format(sumarPorcentaje($cantidadF1,2.2),2). PHP_EOL);
//    fwrite($file,"Pago al 01/09/2022: ".number_format(sumarPorcentaje($cantidadF1,4.4),2). PHP_EOL);
//    fwrite($file,"Pago al 01/10/2022: ".number_format(sumarPorcentaje($cantidadF1,6.6),2). PHP_EOL);
//    fwrite($file,"Pago al 01/11/2022: ".number_format(sumarPorcentaje($cantidadF1,8.8),2). PHP_EOL);
//    fwrite($file,"Pago al 01/12/2022: ".number_format(sumarPorcentaje($cantidadF1,11),2). PHP_EOL);
//    fwrite($file,"Pago al 01/01/2023: ".number_format(sumarPorcentaje($cantidadF1,12.2),2). PHP_EOL);
////    fwrite($file,"Pago despues de 60 dias: ".sumarPorcentaje($cantidadTotal,4.4). PHP_EOL);
////    fwrite($file,"Pago despues de 90 dias: ".sumarPorcentaje($cantidadTotal,6.6). PHP_EOL);
////    fwrite($file,"Pago despues de 120 dias: ".sumarPorcentaje($cantidadTotal,8.8). PHP_EOL);
////    fwrite($file,"Pago despues de 150 dias: ".sumarPorcentaje($cantidadTotal,11). PHP_EOL);
////    fwrite($file,"Pago despues de 180 dias: ".sumarPorcentaje($cantidadTotal,12.2). PHP_EOL);
////    fwrite($file,"Fecha limite pago: ".$fVencVenta. PHP_EOL);
//
////    $printer->text("\n");
////    $printer->text( " Subtotal: "."                 ".$TOTAL);
////    $printer->text("\n");
////    $printer->text( " Interes: "."                 ".$interesVenta." %");
////    $printer->text("\n");
////    $printer->text( " TOTAL: "."                 ".$cantidadTotal);
////    $printer->text("\n");
////    $printer->text("Pago inicial:           ".$pagoInicial);
////    $printer->text("\n");
////    $printer->text("Por pagar:           ".$cantidadTotal-$pagoInicial);
////    $printer->text("\n");
////    $printer->text("Fecha limite pago:  ".$fVencVenta);
////    $printer->text("\n");
////    $printer->text("Cantidad de productos:   ".$totalUnidades);
////    $printer->text("\n\n");
////    $printer->text("¡ Gracias por su compra !");
